      ...
      <div className="container relative max-w-6xl py-3 pt-16 mx-auto mt-20 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-black shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <h1 className="font-mono text-3xl font-bold text-white underlined">
                ...
                <ul className="space-y-2 list-disc">
                  <li className="flex items-start">
                    ...
                    <p className="ml-2 text-white">
                      <code className="font-semibold ">7,777</code>{" "}
                      Hand Drawn ERC-721 NFTs.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="ml-2 text-white">Max Mint Amount 5 Nft per Wallet.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                      <svg
                    ...
                    <p className="ml-2 text-white">0.02 ETH Mint Price</p>
                  </li>

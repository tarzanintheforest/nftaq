...
const Header = () => {
  ...
  return (
    <>
      <Head>
        <title>TARZAN in the forest</title>
        <meta name="description" content="Nft Minting" />
        <link rel="icon" href="/tarzan.ico" />
      </Head>

      <header className="sticky inset-x-0 top-0 z-10 h-20 min-w-full text-white border-b  bg-#1b6f1b backdrop-filter backdrop-blur-lg bg-opacity-30">
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          {/* Logo */}
          <Link href="#">
            <a className="text-2xl font-bold text-success">
          ...
          <nav aria-label="Main Menu">
            <ul className="flex items-center space-x-8">
              ...
              <li className="hover:text-white hover:border-success cursor-pointer px-4 py-2 font-extrabold text-gray-200 border border-black rounded-md">
                <a
                  className=""
                  id="walletButton"
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-6">
              <li>
                <a href="https://testnets.opensea.io/collection/examplenft-adea6uf9rf" target="_blank" rel="noreferrer">
                  <svg
                    className="w-7 h-7"
                    viewBox="0 0 90 90"
                    fill="none"
              ...
              <li>
                <a
                  href="https://twitter.com/eenesaydogan"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://discord.gg/kpuGS6ryHs"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
